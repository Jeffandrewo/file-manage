...
import { changeFolder, getFiles, getFolders } from '../../redux/actionCreators/fileFoldersActionCreator';
...
const DashboardPage = () => {
  ...
  //issues for this useEffect
  useEffect(() => {
    if (pathname.includes('/file/')) {
      setShowSubBar(false);
    } else {
      setShowSubBar(true); // Set it to true for other routes
